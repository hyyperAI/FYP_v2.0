"""
backend/ai/minimax_client.py

Minimax API Integration for AI-powered Upwork job analysis

Usage:
    python backend/ai/minimax_client.py n8n_jobs.json -o data/ --show
"""
...
class MinimaxClient:
    ...
    def analyze_jobs(self, jobs_data: list[dict]) -> dict[str, Any]:
        ...
        self._last_summary = data_summary
    ...
    def _call_api(self, prompt: str) -> str:
        ...
        # NOTE: This is a placeholder - update with actual Minimax API format
        # The URL provided appears to be an image endpoint, not an API
        # You may need to use a different endpoint or format

        # For now, return mock response to test structure
        # Replace with actual API call when endpoint is confirmed
